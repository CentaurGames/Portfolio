...
//  Rocket Racers
//
//  Created by Priyanjoli Mukherjee & Christopher Brown on 1/11/19.
...
class IAPHandler: NSObject {
    ...
    let PURCHASE_ID = "com.centaurgamesonline.Rocket_Racers_RaceTrack"
...
class ViewController: UIViewController, WKUIDelegate {
    ...
    @objc func timeInterval() {
        webView1.evaluateJavaScript("isGamePurchased()") {(result,error) in
            if (result != nil) {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            timer = Timer.scheduledTimer(timeInterval: 1,target: self,selector: #selector(timeInterval),userInfo: nil, repeats: true)
        }
        catch {
